...
export default function Page() {
  return (
    <div className="flex-col w-4/6 justify-between items-center min-h-screen p-24">
      ...
      {/* <Image src={large} /> */}
      <p>
        <span className={gluten.className}>One morning,</span> when Gregor Samsa woke from troubled dreams, he found himself transformed in his bed into a horrible vermin. He lay on his armour-like back, and if he lifted his head a little he could see his brown belly, slightly domed and divided by arches into stiff sections. The bedding was hardly able to cover it and seemed ready to <span>slide off any moment.</span> His many legs, pitifully thin compared with the size of the rest of him, waved about helplessly as he looked.
      </p>
      <p>
